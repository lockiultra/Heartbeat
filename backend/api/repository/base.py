...
class BaseRepository:
    @classmethod
    async def get_all(cls, db: AsyncSession, orm_model: Base) -> list[User]:
        result = await db.execute(select(orm_model))
        return result.scalars().all()

    @classmethod
    async def get_by_id(cls, db: AsyncSession, id: int, orm_model: Base) -> User:
    ...
    @classmethod
    async def create(cls, db: AsyncSession, orm_model: Base, create_scheme: UserCreate)  -> User:
    ...
    @classmethod
    async def update(cls, db: AsyncSession, orm_model: Base, update_scheme: UserUpdate) -> User:
    ...
    @classmethod
    async def delete(cls, db: AsyncSession, orm_model: Base, delete_scheme: UserDelete) -> User:
